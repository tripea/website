			...
			<div style="text-align: center; border: 1px #5E4485">
				...
				<div class="form-group" style="font-size: 2vw;">
					<label for="usr">
						<table>
							<tr>
								<td>Enter profile Id:<input type="number"
									class="form-control" name="profileId">
								</td>
							</tr>
							<tr>
								<td>Transaction Remarks:<input type="text"
									class="form-control" name="transactionRemarks">
								</td>
							</tr>
							<tr>
								<td>Enter Amount(In Rupees):</td>
							</tr>
						</table>
					</label> <input type="text" class="form-control" id="usr" name="amount">
